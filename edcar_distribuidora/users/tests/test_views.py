...
from edcar_distribuidora.users.models import User
from edcar_distribuidora.users.tests.factories import UserFactory
from edcar_distribuidora.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
